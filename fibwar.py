...
def guerra(): #(api)
    tiempoEmpezar = 180
    tiempo = 30
    jugadores = {"David":random.randint(0,9),
    "Dani":random.randint(0,4),
    "Sergi":random.randint(0,4),
    "Alexis":random.randint(0,4),
    "Ferri":random.randint(0,4)}
    ...
    while len(jugadores) > 1:
        ...
        if jugadores[ataca1]*ataque1 > jugadores[ataca2]*ataque2:
            jugadores[ataca1] += random.randint(0,3)
            #foto = ataca1 + ".jpeg"
            ...
            jugadores[ataca2] += random.randint(0,3)
            #foto = ataca2 + ".jpeg"
